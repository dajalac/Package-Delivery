...
class Timer:
    ...
    def take_screen_shot(self):
        for i in loadTruck.get_all_packages():
            item = hash_table.search(i.package_id)
            print("Package ID",item.package_id, "Status", item.package_delivery)
